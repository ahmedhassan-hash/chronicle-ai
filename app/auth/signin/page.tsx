      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold mb-2">
            <span className="gradient-primary">Welcome Back</span>
          </h1>
          <p className="text-muted-foreground">Sign in to your Chronicle AI account</p>
        </div>
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <Input
              type="email"
              placeholder="admin@gmail.com or your@email.com"
              value={email}
              onChange={(e) => setEmail(e.target.value)}
              className="bg-input border-border focus:ring-2 focus:ring-accent"
              disabled={isLoading}
            />
            <p className="text-xs text-muted-foreground">Demo: admin@gmail.com</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">Demo: admin1234</p>
          </div>
