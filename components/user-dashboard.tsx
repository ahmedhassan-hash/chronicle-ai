...
import { Search, TrendingUp, Clock, Zap, Plus } from "lucide-react"
    ...
    <main className="min-h-screen smooth-gradient">
      ...
      <div className="pt-20 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div>
              <h1 className="text-4xl md:text-5xl font-bold mb-2 text-balance leading-tight">
                Your <span className="gradient-primary">Discovery Feed</span>
              </h1>
              <p className="text-muted-foreground text-lg">Explore AI-curated articles tailored for you</p>
            </div>
            <Link href="/articles">
              <Button className="bg-gradient-to-r from-primary to-accent hover:opacity-90 text-accent-foreground px-6">
          ...
          >
            {[
              { icon: TrendingUp, label: "Trending Articles", value: "24" },
